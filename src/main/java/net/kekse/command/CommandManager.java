...
public final class CommandManager {
    ...
    public static final String COMMAND_PREFIX = KeksKlient.INSTANCE.getCommandPrefix();
    ...
    public boolean handleCommand(final String message) {
        ...
        if (message.equalsIgnoreCase(COMMAND_PREFIX)) {
            ChatUtil.addChatMessage(String
                    .format("Type %shelp for a list of commands!", COMMAND_PREFIX, COMMAND_PREFIX)
                    , true);
            return true;
        }
        ...
        try {
            this.getCommand(args[0]).orElseThrow(() ->
                    new CommandException(String
                            .format("Error: Unknown Command\n Type %shelp for a list of commands!", args[0], COMMAND_PREFIX)))
    ...
    public Optional<Command> getCommand(final String commandName) {
        ...
        if (command != null) {
            ...
            return Optional.ofNullable(this.commands.values()
                    ...
                    .findFirst()
                    .orElseThrow(() ->
                            new CommandException("Unknown Command: " + commandName)));
        }
